      ...
      for(Cut c : listCut)
       {
         ...
         if(c.isId((double)c.idClient) && c.isId((double)c.idPlanche) && c.isPos(c.positionX, c.positionY) && c.isId((double)c.idPlanche) && c.isCovering(listCut.get(i),listCut.get(i+1),listClient,listSupplier).compareTo("") != 0)
