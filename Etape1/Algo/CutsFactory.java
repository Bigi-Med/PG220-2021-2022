...
class CutsFactory implements Ifactory
{
...

    {
        ...
        for(int index = 0; index<size;index++)
        {
            ...
            {
               Cut c =  new Cut(Integer.parseInt(ListAtt.get(index+2)),Integer.parseInt(ListAtt.get(index+5)),Double.parseDouble(ListAtt.get(index+3)),Double.parseDouble(ListAtt.get(index+6)),0.0,0.0);
               ListCut.add(c);
            }
        }
